...
backbone_fn = f'{config["bel_resources"]["file_locations"]["data"]}/namespaces/eg_backbone_nanopubs.jsonl.gz'
backbone_hmrz_fn = f'{config["bel_resources"]["file_locations"]["data"]}/namespaces/eg_backbone_nanopubs_hmrz.jsonl.gz'

eg_datafile = '/Users/william/belbio/bel_resources/downloads/eg.jsonl.gz'
backbone_fn = '/Users/william/belbio/bel_resources/downloads/eg_backbone_nanopubs.jsonl.gz'
backbone_hmrz_fn = '/Users/william/belbio/bel_resources/downloads/eg_backbone_nanopubs_hmrz.jsonl.gz'
