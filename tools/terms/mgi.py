...
def update_data_files() -> bool:
    ...
    (changed_main, response_main) = utils.get_web_file(url_main, local_data_main_fp, gzip_flag=gzip_flag, days_old=update_cycle_days)
    (changed2, response2) = utils.get_web_file(url2, local_data_2_fp, gzip_flag=gzip_flag, days_old=update_cycle_days)
    (changed3, response3) = utils.get_web_file(url3, local_data_3_fp, gzip_flag=gzip_flag, days_old=update_cycle_days)
