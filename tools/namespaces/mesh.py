...
local_data_fp = (
    f'{config["bel_resources"]["file_locations"]["downloads"]}/{namespace_key}_{basename}'
)
...
def update_data_files() -> bool:
    ...
    result_concepts = utils.get_ftp_file(
        server, source_data_concepts_fp, local_data_concepts_fp, days_old=update_cycle_days
    )
